...
number, $N$, of objects in a (physical or metaphorical) region. Each of the $N$ objects has a property
...
switching the identities of the objects.

To carry out the inference, we must assign a prior to the objects' properties
$\{\xx_i\}_{i=1}^N$.
...
\end{eqnarray}
and the noise standard deviation was $\sigma = 1$.
...
especially challenging subsets of astronomical imaging.
...
fluxes and one for the widths) and two slopes. As in Section~\ref{sec:sinewaves}
