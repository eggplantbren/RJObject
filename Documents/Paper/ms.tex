...
number, $N$, of components in a (physical or metaphorical) region. Each of the $N$ components has a property
...
To carry out the inference, we must assign a prior to the components' properties
$\{\xx_i\}_{i=1}^N$.
