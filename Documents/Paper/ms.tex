...
hyperparameters, i.e. the interim prior $p(x | \hyperparams)$.
...
drag them so they represent the distribution $p(x | \hyperparams')$ rather than
$p(x|\hyperparams)$. We do this by making use of the transformation functions
